...
class synchro_world_edge_num(object):
    def __init__(self, n_agent, n_round, n_edges, payoff_matrix, network_alg, rl_alg):
    ...
    def create_network(self) -> None:
        ...
        """
        self.G = self.network_alg(n=self.n_agent, m=self.n_edges) # change network
