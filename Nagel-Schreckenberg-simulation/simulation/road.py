...
class Road:
    def __init__(self, lanesCount, length, speedLimits):
        self.lanes = self.generateEmptyLanes(lanesCount, length)
        self.updatedLanes = self.generateEmptyLanes(lanesCount, length)
    ...
    def flipLanes(self):
        ...
        self.updatedLanes = self.generateEmptyLanes(self.getLanesCount(), self.getLength())
    ...
    def generateEmptyLanes(self, lanesCount, length):
        lanes = []
